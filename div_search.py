...
def DivSearch(poly: SparsePoly, verbose:bool=False, care_about_add=False, max_mem=2000, expensive_heuristic=True, div_init_mem=True, analyze_ones=False, test=False):
    """
